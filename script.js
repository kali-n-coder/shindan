...
const questions = [
  ...
  {
    text: "疲れている日に回復しやすいのは？",
    choices: [
      { text: "誰かと話して気分を切り替える", trait: "E" },
      { text: "静かな場所で自分のペースを取り戻す", trait: "I" },
    ],
  },
  {
    text: "資料を読むとき、先に気になるのは？",
    choices: [
      { text: "根拠、数字、具体的な手順", trait: "S" },
      { text: "意図、背景、そこから広がる可能性", trait: "N" },
    ],
  },
  {
    text: "公平な判断をしたいとき、頼りにするのは？",
    choices: [
      { text: "一貫したルールや比較基準", trait: "T" },
      { text: "相手の事情や気持ちへの配慮", trait: "F" },
    ],
  },
  {
    text: "大きめの予定がある前日は？",
    choices: [
      { text: "準備を終えて安心しておきたい", trait: "J" },
      { text: "必要になったらその場で整えたい", trait: "P" },
    ],
  },
  {
    text: "良いニュースがあったとき、自然にしやすいのは？",
    choices: [
      { text: "すぐ誰かに話したくなる", trait: "E" },
      { text: "まず自分の中でじっくり味わう", trait: "I" },
    ],
  },
  {
    text: "新しいツールを触るとき、どちらが近いですか？",
    choices: [
      { text: "基本機能を順番に試して覚える", trait: "S" },
      { text: "何ができそうか想像しながら触る", trait: "N" },
    ],
  },
  {
    text: "相談を受けたとき、最初に返しやすいのは？",
    choices: [
      { text: "問題を整理して解決策を考える", trait: "T" },
      { text: "まず気持ちを受け止めて聞く", trait: "F" },
    ],
  },
  {
    text: "休日の過ごし方で心地いいのは？",
    choices: [
      { text: "やりたいことを先に決めて動く", trait: "J" },
      { text: "起きてから気分で決める", trait: "P" },
    ],
  },
  {
    text: "グループ作業では、どちらが自然ですか？",
    choices: [
      { text: "会話しながら場を動かす", trait: "E" },
      { text: "観察して必要なところで発言する", trait: "I" },
    ],
  },
  {
    text: "アイデアを評価するとき、重視するのは？",
    choices: [
      { text: "実現できる条件がそろっているか", trait: "S" },
      { text: "今後大きく伸びる余地があるか", trait: "N" },
    ],
  },
  {
    text: "意見を伝えるとき、気をつけやすいのは？",
    choices: [
      { text: "論点が曖昧にならないこと", trait: "T" },
      { text: "相手が受け取りやすいこと", trait: "F" },
    ],
  },
  {
    text: "締切が近づくと、どちらになりやすいですか？",
    choices: [
      { text: "早めに形にして仕上げを調整する", trait: "J" },
      { text: "最後の集中力で一気に仕上げる", trait: "P" },
    ],
  },
];
